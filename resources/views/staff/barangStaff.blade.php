          ...
          <section class="col-lg-12 ">
            ...
            <div class="card">
              <div class="card-header">
                <div class="col-md-12">
                    <div class="col-md-12">
                        <form class="form-inline" style="position: relative" action="{{ url('/barangStaff') }}">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <a class="btn btn-danger" href="{{ route('staff.barangStaff') }}" style="color: #fff;">SHOW ALL</a>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <tbody>
                        @forelse($dataBarang as $r => $barang )
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-info" name="btn-update" href="{{ url('/barangStaffUpdate'. $barang->id_bar) }}"> <i class="fas fa-pen"></i></a>
                                </td>
                            </tr>
