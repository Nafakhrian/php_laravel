          ...
          <section class="col-lg-12 ">
            ...
            <div class="card card-success">
              ...
              <div class="card-body">
                ...
                <form method="post" action="{{ url('/jurusan_update_store/' . $dataJurusan->id_jur) }}" autocomplete="off" enctype="multipart/form-data">
                @csrf
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="id_fak" name="id_fak">
                                ...
                                @foreach($dataFakultas as $fak)
                                    <option value="{{ $fak->id_fak }}" {{ ($dataJurusan->id_fak == $fak->id_fak) ? 'selected' : ''}} >{{ $fak->nama_fak }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Nama Jurusan</label>
                            <input type="text" class="form-control" name="nama_jur" id="nama_jur" placeholder="Masukan Nama Fakultas" value="{{ $dataJurusan->nama_jur }}" required>
                        </div>
